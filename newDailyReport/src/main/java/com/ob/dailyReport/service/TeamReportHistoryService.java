...
//	}
	...
	public static List<ProjectReport> getTeamReport(String team, Date date) throws SQLException {
		...
		List<String> employeeList = EmployeeDao.getEmployeeList(team);
...
//	private static List<TaskRecord> getEmployeeReport(String employeeName, Date date) throws SQLException {
